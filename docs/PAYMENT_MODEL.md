...
- uso do mecanismo de ordenação (FIFO);
...
A Plataforma PoE atua como **ponte econômica** entre o mundo off-chain
e o protocolo.
...
Relatórios econômicos gerados pela Plataforma
**PODEM** ter seus hashes registrados no ledger PoE.
