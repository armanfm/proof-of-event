...
- Definição e uso de algoritmos criptográficos off-chain
  (clássicos ou pós-quânticos);
...
- Garantir as regras do FIFO lógico;
- Preservar a definição formal do ledger determinístico.

**A Plataforma NÃO assume responsabilidade por:**
- Veracidade, significado ou legalidade do conteúdo;
- Custódia de dados originais;
- Algoritmos criptográficos usados fora do ledger;
...
> “O Proof of Event garante exclusivamente que um hash foi registrado
> por um Certificador PoE em um ponto temporal específico.
>  
> O protocolo NÃO garante, valida ou assume responsabilidade
> sobre o significado, veracidade, legalidade ou utilidade do conteúdo
> representado pelo hash.
>  
...
O Cliente pode migrar entre Certificadores livremente,
desde que possua o conteúdo correspondente ao hash registrado.
...
- NÃO restringe uso de esquemas clássicos ou pós-quânticos;
- NÃO depende de assinaturas para validade da prova.

A escolha criptográfica é **exclusiva do Verificador/Certificador**.
...
Enquanto houver Certificadores PoE ativos,
o ledger público permanece auditável, verificável e reexecutável.
